...
public class ContactController {
    ...
    public String getContactById(Model model, @PathVariable long contactId) {
        ...
        try {
            ...
            model.addAttribute("errorMessage", "Contact not found --> Контакт не обнаружен");
        }
    ...
    public String updateContact(Model model,
        ...
        try {
            ...
            System.out.println("ContactController.updateContact befor-update ="+ contact.getName()+ "+" + contact.getDate());
            contactService.update(contact);
            System.out.println("ContactController.updateContact after-update ="+ contact.getName()+ "+" + contact.getDate());
